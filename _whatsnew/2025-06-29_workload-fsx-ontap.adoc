...
=== Mejoras en la creación de enlaces

Se han realizado las siguientes mejoras en el proceso de creación de enlaces en la consola de fábrica de carga de trabajo.
...
Ahora puede usar Terraform desde Codebox para crear un enlace y asociarlo con un sistema de archivos de FSx para ONTAP. Esta función está disponible para usuarios que crean enlaces manualmente.
